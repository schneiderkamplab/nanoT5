...
class T5DenseGatedActDense(nn.Module):
    ...
    def forward(self, hidden_states):
        ...
        hidden_states = torch.layer_norm(hidden_states, hidden_states.size()[2:]).type_as(hidden_states)
...
class T5LayerFF(nn.Module):
    ...
    def forward(self, hidden_states):
        forwarded_states = torch.layer_norm(hidden_states, hidden_states.size()[2:]).type_as(hidden_states)
...
class T5Attention(nn.Module):
    ...
    def forward(
        ...
        attn_output = torch.layer_norm(attn_output, attn_output.size()[2:]).type_as(attn_output)
...
class T5LayerSelfAttention(nn.Module):
    ...
    def forward(
        ...
        normed_hidden_states = torch.layer_norm(hidden_states, hidden_states.size()[2:]).type_as(hidden_states)
