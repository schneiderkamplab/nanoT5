...
class T5LayerNorm(nn.Module):
    ...
    def forward(self, hidden_states):
        ...
        return nn.functional.layer_norm(hidden_states, hidden_states.size()[-1:], self.weight, self.bias, self.variance_epsilon)
...
class T5DenseGatedActDense(nn.Module):
    def __init__(self, config: T5Config):
        ...
        self.layer_norm = T5LayerNorm(config.d_ff, eps=config.layer_norm_epsilon)
